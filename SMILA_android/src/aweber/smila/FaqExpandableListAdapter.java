...
public class FaqExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView,
		...
		if (convertView == null) {
			...
			convertView = infalInflater.inflate(R.layout.faq_list_details, null);
		}

		TextView txtListChild = (TextView) convertView.findViewById(R.id.faqListItem);
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		TextView lblListHeader = (TextView) convertView.findViewById(R.id.faqListHeader);
